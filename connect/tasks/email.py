...
def create_friend_joined_message(from_address, to_address, to_name, friendName, friendFacebookID, numberOfNewFriends, totalNumberOfFriends, currentNumberOfFoF):
...
# def create_new_message_message(messageSender, mutualFriendNumber, mutualFriendOne, mutualFriendTwo, mutualFriendThree):
#     from_header = "Mutuality"
#     messageSenderFirstName = messageSender.name.split()[0]
#     subject = "New message from {0}".format(messageSender)
#     text = "Greetings,\n\n{0} just sent you a message on Mutuality. You and {1} share {2} mutual friends including {3}, {4}, and {5}.\n\nView the message at www.mymutuality.com/messages.\n\nBest,\n\nThe Mutuality Team".format(messageSender.name,messageSenderFirstName,mutualFriendNumber,mutualFriendOne.name,mutualFriendTwo.name,mutualFriendThree.name)
#     html = '''<html><title>New message from {0}</title><body style = "margin:0px 0px 0px 0px; padding: 0px 0px 0px 0px; font-family: Tahoma, Geneva, sans-serif;"><!-- Start Main Table --><table width = "100%" height="100%" cellpadding = "0" style="padding:10px 0px 10px 0px" bgcolor="#FFFFFF"><table align = "center" width="560px" height="35px" cellpadding="0px" cellspacing="0" bgcolor="#6ba4c5" style = "color:#FFFFFF; font-weight: regular; padding: 1px 0px 0px 14px; font-family: Tahoma, Geneva, sans-serif;"><tr><td><a href='http://www.mymutuality.com?src=email_message'><img src="http://www.mymutuality.com/images/LogoMedium.jpg" width="126" height="" alt="Logo" border="0"></a></td></tr></table><table width="560px" height = "200px" align="center"><tr><td width="560px" height="140px"><table cellpadding="0" cellspacing="0" width="560px" height="140px" bgcolor="FFFFFF"><tr><td bgcolor="FFFFFF" align="left" style="font-family: Tahoma, Geneva, sans-serif; padding: 5px 10px 0px 15px; font-size: 16px; color:#000; font-weight:regular">{1} just sent you a message on Mutuality</td></tr><tr><td align="left" bgcolor="FFFFFF" style="font-family: Tahoma, Geneva, sans-serif; padding: 0px 10px 0px 15px; font-size: 12px; color:#000; font-weight:regular">You and {2} share <span style="font-size:18px; font-weight:bold">{3}</span> mutual friends including<span style="font-weight:bold">{4}, {5},</span> and <span style="font-weight:bold">{6}</span></td></tr><tr><td align="left" bgcolor="FFFFFF" style="font-family: Tahoma, Geneva, sans-serif; padding: 0px 15px 0px 15px; font-size: 12px; color:#000; font-weight:regular"><table cellpadding="0" cellspacing="0" width="220px" bgcolor="FFFFFF"><tr><td><img src = "https://graph.facebook.com/{7}/picture?width=50&height=50"></td><td><img src = "https://graph.facebook.com/{8}/picture?width=50&height=50"></td><td><img src = "https://graph.facebook.com/{9}/picture?width=50&height=50"></td></tr></table></td></tr></table></td></tr><tr><td><table align="left"><tr><td align="left" bgcolor="FFFFFF" style="font-family: Tahoma, Geneva, sans-serif; padding: 10px 15px 20px 15px; font-size: 16px; color:#000; font-weight:regular"><a href="http://www.mymutuality.com/messages?email_message">View the message on Mutuality</a></td></tr></table></td></tr></table><table width="560" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF"><tr><td width="50"></td><td width="410" align="right" height="30" style="font-family: Tahoma, Geneva, sans-serif; padding: 0px 0px 0px 0px; font-size: 6px; color:#DDD; font-weight:regular; border-top:1px solid #DDD">This email was sent by Mutuality. Mutuality helps you meet cool people through your mutual friends.<br>If you received this in error, please click <a href="#" style="color:#ccc">here</a> to unsubscribe.</td></tr></table></table></body></html>'''.format(messageSender.name,messageSender.name,messageSenderFirstName,mutualFriendNumber,mutualFriendOne.name, mutualFriendTwo.name, mutualFriendThree.name,mutualFriendOne.facebookID,mutualFriendTwo.facebookID, mutualFriendThree.facebookID)
#     message=sendgrid.Message(from_header, subject, text, html)
