...
def send_new_message_email(message):
    ...
    email = create_new_message_message(from_address, sender_name, mutual_friend_count, mutual_friend_name)
...
def create_new_message_message(from_address, sender_name, mutualFriendNumber, mutual_friend_name):
    from_header = from_address
